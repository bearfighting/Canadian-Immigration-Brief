...
const labels: Record<NonNullable<Content["policyStatus"]>, string> = {
  effective: "已生效",
  announced: "已宣布，尚未生效",
  consultation: "咨询中",
  suspended: "暂停",
...
const styles: Record<NonNullable<Content["policyStatus"]>, string> = {
...
export function PolicyStatusBadge({ status }: { status?: Content["policyStatus"] }) {
